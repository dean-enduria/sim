...
export const OutputPanel = React.memo(function OutputPanel({
  ...
  return (
    <>
      <div
        className='absolute top-0 right-0 bottom-0 flex flex-col border-l border-[var(--border-soft)] bg-[var(--bg)]'
      ...
      >
        ...
        {isOutputSearchActive && (
          <div
            className='absolute top-[30px] right-[8px] z-30 flex h-[34px] items-center gap-[6px] rounded-b-[4px] border border-[var(--border-soft)] border-t-0 bg-[var(--bg)] px-[6px] shadow-sm'
            onClick={(e) => e.stopPropagation()}
            data-toolbar-root
