...
import {
  enduriaAssetCreatedTrigger,
  enduriaAssetDiscoveredTrigger,
  enduriaAssetMaintenanceDueTrigger,
  enduriaAssetRetiredTrigger,
  enduriaAssetUpdatedTrigger,
  enduriaChangeApprovedTrigger,
  enduriaChangeClosedTrigger,
  enduriaChangeCreatedTrigger,
  enduriaChangeImplementedTrigger,
  enduriaChangeRejectedTrigger,
  enduriaChangeSubmittedTrigger,
  enduriaClientCreatedTrigger,
  enduriaClientUpdatedTrigger,
  enduriaIncidentAcknowledgedTrigger,
  enduriaIncidentCreatedTrigger,
  enduriaIncidentEscalatedTrigger,
  enduriaIncidentResolvedTrigger,
  enduriaIncidentTriggeredTrigger,
  enduriaIncidentUpdatedTrigger,
  enduriaKbArticleArchivedTrigger,
  enduriaKbArticleDeletedTrigger,
  enduriaKbArticlePublishedTrigger,
  enduriaKbArticleUpdatedTrigger,
  enduriaProjectCreatedTrigger,
  enduriaProjectMilestoneReachedTrigger,
  enduriaProjectTaskCompletedTrigger,
  enduriaProjectTaskOverdueTrigger,
  enduriaSlaBrechedTrigger,
  endurialSlaWarningTrigger,
  enduriaTicketAssignedTrigger,
  enduriaTicketCommentedTrigger,
  enduriaTicketCreatedTrigger,
  enduriaTicketEscalatedTrigger,
  enduriaTicketPriorityChangedTrigger,
  enduriaTicketReopenedTrigger,
  enduriaTicketResolvedTrigger,
  enduriaTicketStatusChangedTrigger,
  enduriaTicketUpdatedTrigger,
  enduriaWebhookTrigger,
} from '@/triggers/enduria'
import {
...
export const TRIGGER_REGISTRY: TriggerRegistry = {
  ...
  enduria_webhook: enduriaWebhookTrigger,
  enduria_ticket_created: enduriaTicketCreatedTrigger,
  enduria_ticket_updated: enduriaTicketUpdatedTrigger,
  enduria_ticket_assigned: enduriaTicketAssignedTrigger,
  enduria_ticket_escalated: enduriaTicketEscalatedTrigger,
  enduria_ticket_resolved: enduriaTicketResolvedTrigger,
  enduria_ticket_reopened: enduriaTicketReopenedTrigger,
  enduria_ticket_commented: enduriaTicketCommentedTrigger,
  enduria_ticket_priority_changed: enduriaTicketPriorityChangedTrigger,
  enduria_ticket_status_changed: enduriaTicketStatusChangedTrigger,
  enduria_incident_created: enduriaIncidentCreatedTrigger,
  enduria_incident_triggered: enduriaIncidentTriggeredTrigger,
  enduria_incident_updated: enduriaIncidentUpdatedTrigger,
  enduria_incident_escalated: enduriaIncidentEscalatedTrigger,
  enduria_incident_resolved: enduriaIncidentResolvedTrigger,
  enduria_incident_acknowledged: enduriaIncidentAcknowledgedTrigger,
  enduria_change_created: enduriaChangeCreatedTrigger,
  enduria_change_submitted: enduriaChangeSubmittedTrigger,
  enduria_change_approved: enduriaChangeApprovedTrigger,
  enduria_change_rejected: enduriaChangeRejectedTrigger,
  enduria_change_implemented: enduriaChangeImplementedTrigger,
  enduria_change_closed: enduriaChangeClosedTrigger,
  enduria_asset_created: enduriaAssetCreatedTrigger,
  enduria_asset_updated: enduriaAssetUpdatedTrigger,
  enduria_asset_discovered: enduriaAssetDiscoveredTrigger,
  enduria_asset_retired: enduriaAssetRetiredTrigger,
  enduria_asset_maintenance_due: enduriaAssetMaintenanceDueTrigger,
  enduria_kb_article_published: enduriaKbArticlePublishedTrigger,
  enduria_kb_article_updated: enduriaKbArticleUpdatedTrigger,
  enduria_kb_article_archived: enduriaKbArticleArchivedTrigger,
  enduria_kb_article_deleted: enduriaKbArticleDeletedTrigger,
  enduria_project_created: enduriaProjectCreatedTrigger,
  enduria_project_task_completed: enduriaProjectTaskCompletedTrigger,
  enduria_project_task_overdue: enduriaProjectTaskOverdueTrigger,
  enduria_project_milestone_reached: enduriaProjectMilestoneReachedTrigger,
  enduria_sla_breached: enduriaSlaBrechedTrigger,
  enduria_sla_warning: endurialSlaWarningTrigger,
  enduria_client_created: enduriaClientCreatedTrigger,
  enduria_client_updated: enduriaClientUpdatedTrigger,
